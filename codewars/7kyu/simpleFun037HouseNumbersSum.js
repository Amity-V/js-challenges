// Link: https://www.codewars.com/kata/58880c6e79a0a3e459000004/javascript

/*

A boy is walking a long way from school to his home. To make the walk more fun he
decides to add up all the numbers of the houses that he passes by during his walk.
Unfortunately, not all of the houses have numbers written on them, and on top of
that the boy is regularly taking turns to change streets, so the numbers don't
...
const houseNumbersSum = (inputArray) => {
  ...
  return inputArray.slice(0, zeroIdx).reduce((a, c) => a + c, 0);
};
...
const houseNumbersSum = (a) =>
  a.reduce((x, y, i) => x + (i < a.indexOf(0) ? y : 0), 0);
