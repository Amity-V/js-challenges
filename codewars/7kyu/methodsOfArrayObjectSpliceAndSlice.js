// Link: https://www.codewars.com/kata/572cb264362806af46000793
...
Note2: Because this is a beginner Kata, and due to the author's mercy ;-), so you do not
have to verify the validity of the parameter, and do not worry about the number of elements
of the array is not a multiple of 3.
...
const threeInOne = (arr) => {
  ...
  for (let i = 0; i < arr.length / 3; i += 1) {
    ...
    for (let j = 0; j < 3; j += 1) {
      num += Number(arrCopy.splice(arrCopy.length - 1));
    }
